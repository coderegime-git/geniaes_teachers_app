...
// class TeacherBlogsListWidget extends StatefulWidget {
//   final String teacherBlogsSlug;
//   TeacherBlogsListWidget({
//     super.key,
//     required this.teacherBlogsSlug,
//   });

//   @override
//   State<TeacherBlogsListWidget> createState() => _TeacherBlogsListWidgetState();
// }

// class _TeacherBlogsListWidgetState extends State<TeacherBlogsListWidget> {
//   final logic = Get.put(TeacherReviewsController());

//   @override
//   void initState() {
//     super.initState();
//     postMethod(context, '$getTeacherReviews/${widget.teacherBlogsSlug}', null,
