...
class TeacherSocialInfoWidget extends StatefulWidget {
  ...
  @override
  State<TeacherSocialInfoWidget> createState() => _TeacherSocialInfoWidgetState();
}
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 14),
            _buildSocialRow(Icons.play_circle_fill,'youtube_url',   "Youtube Url"),
            const SizedBox(height: 14),
  ...
  Widget _buildForm() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 20),
        TextFormFieldWidget(hintText: "Name (en)", onChanged: (v){}, validator: (v)=>null),
        const SizedBox(height: 14),
        TextFormFieldWidget(hintText: "Description (en)", onChanged: (v){}, validator: (v)=>null),
        const SizedBox(height: 14),
        Row(
          children: [
            Expanded(child: TextFormFieldWidget(hintText: "Choose Category", onChanged: (v){}, validator: (v)=>null)),
            const SizedBox(width: 10),
            Expanded(child: TextFormFieldWidget(hintText: "Choose Tag", onChanged: (v){}, validator: (v)=>null)),
          ],
        ),
        const SizedBox(height: 14),
        Container(
          padding: const EdgeInsets.all(12),
          decoration: BoxDecoration(color: AppColors.primaryColor.withOpacity(0.15), borderRadius: BorderRadius.circular(30)),
          child: Row(
            children: [
              SizedBox(
                 width: 120,
                 child: ButtonWidgetOne(onTap: () {}, buttonText: "Select a File", buttonTextStyle: AppTextStyles.buttonTextStyle9, borderRadius: 40, buttonColor: const LinearGradient(colors: [Color(0xff4b4c4d), Color(0xff4b4c4d)]))),
              const SizedBox(width: 10),
              const Expanded(child: Text("File Must Be Of Type doc, docx, pdf, xls, png, jpeg", maxLines: 2, overflow: TextOverflow.ellipsis)),
            ],
          ),
        ),
        const SizedBox(height: 14),
        Row(children: [Switch(value: isActive, onChanged: (v){ setState((){isActive = v;}); }), const Text("Active?")]),
        const SizedBox(height: 20),
        Row(
          mainAxisAlignment: MainAxisAlignment.end,
          children: [
            SizedBox(width: 100, child: ButtonWidgetOne(onTap: () => setState(() => isVisibleBlogForm = false), buttonText: "Cancel", buttonTextStyle: AppTextStyles.buttonTextStyle1, borderRadius: 40, buttonColor: const LinearGradient(colors: [Color(0xff2d2e2f), Color(0xff2d2e2f)]))),
            const SizedBox(width: 10),
            SizedBox(width: 100, child: ButtonWidgetOne(onTap: () => setState(() => isVisibleBlogForm = false), buttonText: "Create", buttonTextStyle: AppTextStyles.buttonTextStyle1, borderRadius: 40, buttonColor: AppColors.gradientOne)),
          ],
        )
      ],
    );
  ...
  void _saveCalendly() {
    if (_calendlyController.text.trim().isEmpty) {
      Get.snackbar('Error', 'Please enter a Calendly link',
          backgroundColor: AppColors.carrotRed,
          colorText: AppColors.white);
      return;
    }
      ...
      children: [
        Row(
          ...
          children: [
            ...
            SizedBox(
              width: 100,
              child: ButtonWidgetOne(onTap: () => setState(() => isVisibleForm = true), buttonText: "Add New", buttonTextStyle: AppTextStyles.buttonTextStyle9, borderRadius: 40, buttonColor: AppColors.gradientOne),
            ),
          ],
        ),
        const SizedBox(height: 20),
  ...
  Widget _buildForm() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 20),
        TextFormFieldWidget(hintText: "Event Name (en)", onChanged: (v){}, validator: (v)=>null),
        const SizedBox(height: 14),
        TextFormFieldWidget(hintText: "Description (en)", onChanged: (v){}, validator: (v)=>null),
        const SizedBox(height: 14),
        Row(
        ...
        Row(
          children: [
            Expanded(child: TextFormFieldWidget(hintText: "Start Date", onChanged: (v){}, validator: (v)=>null)),
            const SizedBox(width: 10),
            Expanded(child: TextFormFieldWidget(hintText: "End Date", onChanged: (v){}, validator: (v)=>null)),
          ],
        ),
        const SizedBox(height: 14),
        Row(
          children: [
            Expanded(child: TextFormFieldWidget(hintText: "Address line 1", onChanged: (v){}, validator: (v)=>null)),
            const SizedBox(width: 10),
            Expanded(child: TextFormFieldWidget(hintText: "Address line 2", onChanged: (v){}, validator: (v)=>null)),
          ],
        ),
        const SizedBox(height: 14),
        ...
        Container(
          ...
          child: Row(
            children: [
              SizedBox(width: 120, child: ButtonWidgetOne(onTap: () {}, buttonText: "Select a File", buttonTextStyle: AppTextStyles.buttonTextStyle9, borderRadius: 40, buttonColor: const LinearGradient(colors: [Color(0xff4b4c4d), Color(0xff4b4c4d)]))),
              const SizedBox(width: 10),
              const Expanded(child: Text("File Must Be Of Type doc, docx, pdf, xls, png, jpeg", maxLines: 2, overflow: TextOverflow.ellipsis)),
            ],
          ),
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.end,
          children: [
            SizedBox(width: 100, child: ButtonWidgetOne(onTap: () => setState(() => isVisibleForm = false), buttonText: "Cancel", buttonTextStyle: AppTextStyles.buttonTextStyle1, borderRadius: 40, buttonColor: const LinearGradient(colors: [Color(0xff2d2e2f), Color(0xff2d2e2f)]))),
            const SizedBox(width: 10),
            SizedBox(width: 100, child: ButtonWidgetOne(onTap: () => setState(() => isVisibleForm = false), buttonText: "Create", buttonTextStyle: AppTextStyles.buttonTextStyle1, borderRadius: 40, buttonColor: AppColors.gradientOne)),
          ],
        )
      ],
    );
      ...
      children: [
        Row(
          children: [
            Expanded(child: TextFormFieldWidget(hintText: "Choose Category", onChanged: (v){}, validator: (v)=>null)),
            const SizedBox(width: 10),
            Expanded(child: TextFormFieldWidget(hintText: "Price", onChanged: (v){}, validator: (v)=>null)),
          ],
        ),
        const SizedBox(height: 14),
        TextFormFieldWidget(hintText: "Choose Tag", onChanged: (v){}, validator: (v)=>null),
        const SizedBox(height: 14),
        Text("Image", style: AppTextStyles.bodyTextStyle2),
        const SizedBox(height: 10),
        Row(
          children: [
            SizedBox(width: 120, child: ButtonWidgetOne(onTap: () {}, buttonText: "Choose File", buttonTextStyle: AppTextStyles.buttonTextStyle9, borderRadius: 40, buttonColor: const LinearGradient(colors: [Color(0xff4b4c4d), Color(0xff4b4c4d)]))),
            const SizedBox(width: 10),
            const Expanded(child: Text("No file chosen", maxLines: 1, overflow: TextOverflow.ellipsis)),
          ],
        ),
        const SizedBox(height: 14),
        TextFormFieldWidget(hintText: "Name (en)", onChanged: (v){}, validator: (v)=>null),
        ...
        TextFormFieldWidget(hintText: "Description (en)", onChanged: (v){}, validator: (v)=>null),
        const SizedBox(height: 14),
        SizedBox(width: 100, child: ButtonWidgetOne(onTap: () {}, buttonText: "Add FAQ", buttonTextStyle: AppTextStyles.buttonTextStyle9, borderRadius: 10, buttonColor: const LinearGradient(colors: [Color(0xff2d2e2f), Color(0xff2d2e2f)]))),
        const SizedBox(height: 14),
        Row(children: [Switch(value: isActive, onChanged: (v){ setState((){isActive = v;}); }), const Text("Active?")]),
        const SizedBox(height: 20),
        Row(
...
class TeacherBroadcastsWidget extends StatefulWidget {
  ...
  @override
  State<TeacherBroadcastsWidget> createState() => _TeacherBroadcastsWidgetState();
}
  ...
  Widget _buildForm() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 14),
        TextFormFieldWidget(hintText: "Choose file type", onChanged: (v){}, validator: (v)=>null),
        const SizedBox(height: 14),
        TextFormFieldWidget(hintText: "File link", onChanged: (v){}, validator: (v)=>null),
        const SizedBox(height: 14),
        Container(
          padding: const EdgeInsets.all(12),
          decoration: BoxDecoration(color: AppColors.primaryColor.withOpacity(0.15), borderRadius: BorderRadius.circular(30)),
